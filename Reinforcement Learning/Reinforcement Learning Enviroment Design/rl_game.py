...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.rect.x = random.randrange(0,WIDHT-self.rect.width)
...
class DQLAgent:
    ...
    def __init__(self):
        ...
        self.gamma = 0.95 # future reward'u belirliyor
        self.learning_rate = 0.001 # agent'ın öğrenme hızını belirliyor
        
        self.epsilon = 1 # explore value
        self.epsilon_decay = 0.995
        self.epsilon_min = 0.01 # like treshold
    ...
    def build_model(self):
        ...
        model = Sequential()
        model.add(Dense(48,input_dim = self.state_size,activation = "relu" )) # hidden layer
        model.add(Dense(self.action_size,activation = "linear"))  # output layer
        model.compile(loss="mse",optimizer = Adam(lr = self.learning_rate)) # loss function
        return model
